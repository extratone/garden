...
>   
```
drafts://x-callback-url/create?text=[[snippets/draft|draft]]&action=Message&x-success=tweetbot%3A//
```
...
>   
```
launchpro://?url=tweetbot://viticci/post?text=[dropbox:Apps/Drafts/Shared/[[title|title]].txt]
```
...
>   
```
[dropbox:Apps/Drafts/Shared/[[title|title]].txt]
```
