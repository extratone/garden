...
tags: documentation, git, reference
davodtime: 09082022-105531
local: shareddocuments:///private/var/mobile/Library/Mobile%20Documents/iCloud~md~obsidian/Documents/OBSHIDDIAN/drafts/A5DA4C1A-0365-45A9-AE88-23714125A418.md
dg-publish: true
share: true
draft: drafts://open?uuid=A5DA4C1A-0365-45A9-AE88-23714125A418
---

- [WTF](https://davidblue.wtf/drafts/A5DA4C1A-0365-45A9-AE88-23714125A418.html)
- [Simplenote Local](simplenote://note/b1fb542919e84a999998da75fb674b07)
- [Simplenote Publish](http://simp.ly/publish/6ZMrY3)
...
Within Jekyll pages and posts, repository information is available within the `site.github` namespace, and can be displayed, for example, using `%20site.github.project_title%20`.
