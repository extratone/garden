---
{"dg-publish":true,"permalink":"/snippets/javascript-example-document/","dgHomeLink":true,"dgPassFrontmatter":false}
---
...
Tags:
  documentation, example, js, reference, simplenote, snippets, template