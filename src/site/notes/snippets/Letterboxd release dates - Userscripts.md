---
{"dg-publish":true,"permalink":"/snippets/letterboxd-release-dates-userscripts/","dgHomeLink":true,"dgPassFrontmatter":false}
---

# Letterboxd release dates - Userscripts
```js
// ==UserScript==
