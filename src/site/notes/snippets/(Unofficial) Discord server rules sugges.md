---
{"dg-publish":true,"permalink":"/snippets/unofficial-discord-server-rules-sugges/","dgHomeLink":true,"dgPassFrontmatter":false}
---

(Unofficial) Discord server rules suggestions list (2)
