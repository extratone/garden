---
{"dg-publish":true,"permalink":"/snippets/indexme-sh/","dgHomeLink":true,"dgPassFrontmatter":false}
---

# indexme.sh
Updated `08272022-063417`
...
header () {
    ...
    echo "<h1>Directory listing for <strong>$I_TITLE</strong></h1>"
}
...
.dir { border-left-color: white; }
.html { border-left-color: yellow; }
.py, .rb, .js, .json, .css, .sh, .hs, .c, .h, .cpp, .rs { border-left-color: red; }
...
Tags:
  documentation, index, reference, sh, shell, simplenote, snippets, software